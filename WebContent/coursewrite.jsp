...
<body>
	<section>
		<form action="courseOK.cs" name="joinForm" method="post">
			...
			<p>
				<label>
					코스정보 : <input type="text" name="courseDetail">
				</label>
			</p>
			<p>
				<label>
...
<script src="//dapi.kakao.com/v2/maps/sdk.js?appkey=90266a5ec90bc57cdea6bcfda8c42652&libraries=services"></script>
<script>
	function join(){
		joinForm.submit();
	}
    ...
    function sample5_execDaumPostcode2() {
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                // 주소 정보를 해당 필드에 넣는다.
                document.getElementById("sample5_address2").value = addr2;
                // 주소로 상세 정보를 검색
                geocoder2.addressSearch(data.address, function(results, status) {
                    ...
                    if (status === daum.maps.services.Status.OK) {
                        ...
                        // 해당 주소에 대한 좌표를 받아서
                        var coords2 = new daum.maps.LatLng(result.y, result.x);
                        // 지도를 보여준다.
