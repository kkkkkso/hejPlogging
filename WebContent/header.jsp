					...
					<div class = "box">
						<div class = "left">
							<div id = "login">
								<form>
									<!-- 로그인버튼 -->
									<button type="button" id="join_btn" style="color: #212122; background:white; font-size:2em; width:320.03px;height:43.16px;font-size:15px; border:1px solid rgba(122, 121, 121, 0.75);">ID/PW 회원가입</button>
									...
									<div>
										<button type="button" style="height: 42px;background-color: #feeB00;border:1px solid #eee;;padding: 0;color: #3c1e1e;font-size:14px;width:100%;"><i class="icon_kakao"></i>카카오로 시작하기</button>
									</div>
								</form>
							</div>
						</div>
				...
				<form name="login">
					...
					<div class = "box">
						...
						<!-- 이메일 비밀번호 입력창 -->
							...
							<!-- 가입하기 -->
							<button type="button" style="color: white; background:#f5afaf; font-size:2em; width:320.03px;height:43.16px;font-size:15px; border:1px solid #f5afaf;">로그인</button>
						</div>
					</div>
				</form>
			</div>
							...
							<div class = check_box_agree > 
								<a class = check_box_agree>
									...
									<label for="input-lable">
										<div class = "join-id">
											<span class = "join-id">모두 동의합니다.</span>
										</div>
									</label>
								</a>
							</div>
